...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, ReactiveFormsModule, ButtonModule, InputTextModule, TextareaModule, FileUploadModule, ConfirmDialogModule, InputNumberModule, CalendarModule, DropdownModule, SelectButtonModule, RouterModule, ToastModule],
...
export class DetailsExerciceComponent {
        ...
        if (this.exerciceForm.valid) {
            ...
            if (confirmed) {
                if (this.exerciceId != 'null') {
                    ...
                    this.exerciceService.addExercice({... this.exerciceForm.value,file:this.selectedImage}).subscribe((res: any) => {
    ...
    updateExercice() {
        if (this.exerciceForm.valid) {
            this.exerciceService.updateExercice(this.exerciceId,{... this.exerciceForm.value,file:this.selectedImage}).subscribe((res: any) => {
